--EXEC [dbo].[sp_procc_portofolio_daily];
--EXEC [dbo].[sp_procc_dataget_suspect_supercif];

BEGIN TRY
	DROP TABLE #LIST_SUSPECT;
	DROP TABLE #REKAP_ADJUSTMENT;
...
BEGIN
	...
	UPDATE #RESULT_TABLE
		...
		LEFT JOIN [NEW_BSI_STORAGE].[dbo].[BSI.PORTOFOLIO_DAILY.2023-05-30] [SOURCE]
